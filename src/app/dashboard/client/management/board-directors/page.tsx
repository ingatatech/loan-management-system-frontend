...
const BoardDirectorsManagement: React.FC = () => {
  ...
  const handleEdit = (director: BoardDirector) => {
    dispatch(setCurrentDirector(director))
    router.push(`/management/board-directors/edit/${director.id}`)
  }
    ...
    <AnimatePresence>
      {viewDialogOpen && selectedDirector && (
        ...
        >
          ...
          >
            {/* Enhanced Header */}
            <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-600 px-8 py-6 relative">
              <div className="flex items-center justify-between">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between py-2">
                        ...
                        <span className="text-sm text-gray-900 w-2/3 text-right">{selectedDirector.name}</span>
                      </div>
                      <div className="flex justify-between py-2 bg-gray-50 px-3 rounded">
                        ...
                        <span className="text-sm text-gray-900 w-2/3 text-right font-medium">{selectedDirector.position}</span>
                      </div>
                      <div className="flex justify-between py-2">
                        <span className="text-sm font-medium text-gray-600 w-1/3">Nationality:</span>
                        <span className="text-sm text-gray-900 w-2/3 text-right">{selectedDirector.nationality}</span>
                      </div>
                      <div className="flex justify-between py-2 bg-gray-50 px-3 rounded">
                        <span className="text-sm font-medium text-gray-600 w-1/3">ID/Passport:</span>
                        <span className="text-sm text-gray-900 w-2/3 text-right">{selectedDirector.idPassport}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between py-2">
                        ...
                        <span className="text-sm text-gray-900 w-2/3 text-right break-all">{selectedDirector.email || 'Not provided'}</span>
                      </div>
                      <div className="flex justify-between py-2 bg-gray-50 px-3 rounded">
                        <span className="text-sm font-medium text-gray-600 w-1/3">Phone:</span>
                        <span className="text-sm text-gray-900 w-2/3 text-right">{selectedDirector.phone || 'Not provided'}</span>
                      </div>
                    </div>
                  </div>
                    ...
                    {selectedDirector.address ? (
                      <div className="space-y-3">
                        <div className="flex justify-between py-2">
                          ...
                          <span className="text-sm text-gray-900 w-2/3 text-right">{selectedDirector.address.country}</span>
                        </div>
                        {selectedDirector.address.province && (
                          <div className="flex justify-between py-2 bg-gray-50 px-3 rounded">
                            <span className="text-sm font-medium text-gray-600 w-1/3">Province:</span>
                            <span className="text-sm text-gray-900 w-2/3 text-right">{selectedDirector.address.province}</span>
                          </div>
                        )}
                        {selectedDirector.address.district && (
                          <div className="flex justify-between py-2">
                            <span className="text-sm font-medium text-gray-600 w-1/3">District:</span>
                            <span className="text-sm text-gray-900 w-2/3 text-right">{selectedDirector.address.district}</span>
                          </div>
                        )}
                        {selectedDirector.address.sector && (
                          <div className="flex justify-between py-2 bg-gray-50 px-3 rounded">
                            <span className="text-sm font-medium text-gray-600 w-1/3">Sector:</span>
                            <span className="text-sm text-gray-900 w-2/3 text-right">{selectedDirector.address.sector}</span>
                          </div>
                        )}
                        {selectedDirector.address.street && (
                          <div className="flex justify-between py-2">
                            <span className="text-sm font-medium text-gray-600 w-1/3">Street:</span>
                            <span className="text-sm text-gray-900 w-2/3 text-right">{selectedDirector.address.street}</span>
                          </div>
                        )}
                        {selectedDirector.address.poBox && (
                          <div className="flex justify-between py-2 bg-gray-50 px-3 rounded">
                            <span className="text-sm font-medium text-gray-600 w-1/3">P.O. Box:</span>
                            <span className="text-sm text-gray-900 w-2/3 text-right">{selectedDirector.address.poBox}</span>
                          </div>
                        )}
                      </div>
                    ) : (
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="py-2">
                        <span className="text-sm font-medium text-gray-600 block mb-1">Current Occupation:</span>
                        <p className="text-sm text-gray-900 bg-gray-50 p-3 rounded">
                          {selectedDirector.currentOccupation || 'Not specified'}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                      <p className="text-sm text-gray-700 whitespace-pre-wrap leading-relaxed">
                        {selectedDirector.qualifications}
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-green-50 p-4 rounded-lg border border-green-100">
                      <p className="text-sm text-gray-700 whitespace-pre-wrap leading-relaxed">
                        {selectedDirector.experience || 'No experience information available'}
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between py-2">
                        ...
                        <span className="text-sm text-gray-900 w-1/2 text-right">
                          {selectedDirector.createdAt ?
                            new Date(selectedDirector.createdAt).toLocaleDateString('en-US', {
                      ...
                      <div className="flex justify-between py-2 bg-gray-50 px-3 rounded">
                        ...
                        <span className="text-sm text-gray-900 w-1/2 text-right">
                          {selectedDirector.updatedAt ?
                            new Date(selectedDirector.updatedAt).toLocaleDateString('en-US', {
                              year: 'numeric', month: 'short', day: 'numeric'
                            }) : 'Never'
                          }
                        </span>
            ...
            {/* Enhanced Footer */}
            <div className="bg-gradient-to-r from-gray-50 to-blue-50 px-8 py-4 border-t border-gray-200 flex items-center justify-between">
              <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                <button
                  ...
                  className="px-4 py-2 bg-[#5B7FA2] hover:bg-blue-700 text-white rounded-lg transition-colors duration-200 flex items-center text-sm"
                >
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600">
                Manage your organization's board of directors
              </p>
            </div>
